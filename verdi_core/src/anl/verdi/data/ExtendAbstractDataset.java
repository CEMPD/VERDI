...
public abstract class ExtendAbstractDataset implements ExtendDataset {
	 ...
	 */
	protected ExtendAbstractDataset(URL url) {
		this.url = url;
	}
	 ...
	 */
	public ExtendAxes<ExtendCoordAxis> getCoordAxes() {
		return new ExtendAxes<ExtendCoordAxis>();
	}
	 ...
	 * recreated to be used again. NOTE: Empty body for this method.
	 */
