...
/**
 * This interface need to be used together with Dataset. 
 * It deal with Dimensions bedside Time, Z besides X, Y.
 *
 * @author Jizhen (Jason) Zhao
 * @version $Revision$ $Date$
 */

public interface ExtendDataset {	
	...
	/**
	 * Gets the coordinate ExtendAxes for this Dataset.
	 *
	 * @return the coordinate ExtendAxes for this Dataset.
	 */
	ExtendAxes<ExtendCoordAxis> getCoordAxes();
