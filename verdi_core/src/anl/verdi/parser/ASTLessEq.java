/* Generated By:JJTree: Do not edit this line. ASTLessEq.java */
...
public class ASTLessEq extends SimpleNode {
  ...
  public ASTLessEq(Parser p, int id) {
    super(p, id);
  }
	...
	public FormulaArray evaluate(Frame frame) throws IllegalFormulaException {
		return jjtGetChild(0).evaluate(frame).lessThanEq(jjtGetChild(1).evaluate(frame));
	}
