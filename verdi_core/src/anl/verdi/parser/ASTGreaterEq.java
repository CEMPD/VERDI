/* Generated By:JJTree: Do not edit this line. ASTGreaterEq.java */
...
public class ASTGreaterEq extends SimpleNode {
  ...
  public ASTGreaterEq(Parser p, int id) {
    super(p, id);
  }
	...
	public FormulaArray evaluate(Frame frame) throws IllegalFormulaException {
		return jjtGetChild(0).evaluate(frame).greaterThanEq(jjtGetChild(1).evaluate(frame));
	}
