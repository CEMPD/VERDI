...
// From FastTileEditorstep

/**
 * @author Nick Collier
 * @version $Revision: 1.5 $ $Date: 2007/05/16 22:20:57 $
 */
public class GTTileEditorStep extends PanelWizardStep {

	private static final long serialVersionUID = -3910162428960110620L;
	static final Logger Logger = LogManager.getLogger(GTTileEditorStep.class.getName());
...
//	private MapLayer aMapLayer;		// 2014 see above w.r.t. deprecated
	...
	public GTTileEditorStep() {
		this(null);
		Logger.debug("default constructor for GTTileEditorStep");
	}
	
	public GTTileEditorStep(FeatureLayer control) {
		super("Edit Style", "Please edit this layer's style");
		Logger.debug("in constructor for GTTileEditorStep, control = " + control);
...
//		aMapLayer = control.;
	...
	public void init(WizardModel wizardModel) {
		model = (GTTileAddLayerWizardModel) wizardModel;
	}
...
//		System.err.println("in anl.verdi.gis.GTTileEditorStep.prepare(); Unable to assign controlLayer this version of libraries.");
...
//		add(panel, BorderLayout.CENTER);
	...
	public void applyState() throws InvalidStateException {
		Logger.debug("in GTTileEditorStep.applyState, ready for model");
		GTTileAddLayerWizardModel aModel = model;
...
//		model.getLayer().setStyle(panel.getStyle());
		Logger.debug("done in GTTileEditorStep.applyState & returning");
	}
}
