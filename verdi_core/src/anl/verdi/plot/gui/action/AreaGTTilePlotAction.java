///**
// * AreaGTTilePlotAction - Callback for AreaGTTilePlot button; modified from ArealInterpolation
// * @author Mary Ann Bitz , modified Jo Ellen Brandmeyer, Institute for the Environment, University of North Carolina Chapel Hill
...
//
//public class AreaGTTilePlotAction extends AbstractSAFAction<VerdiApplication> {
//
...
//	static final Logger Logger = LogManager.getLogger(AreaGTTilePlotAction.class.getName());
//
