 ...
 * @author User #2
 */
public class LegendLabelPanel extends JPanel {
...
//				}));
		...
		add(colorFld, new CellConstraints(5, 9, 1, 1, CellConstraints.DEFAULT, CellConstraints.DEFAULT, new Insets(4, 0, 4, 0)));
