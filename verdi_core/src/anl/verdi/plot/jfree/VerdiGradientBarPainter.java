...
/**
 * A rendering issue between GradientPaint and EPS Image causes gradients to be
 * rendered in all black or white.  This class draws renders to a temporary image
 * then copies the image to the EPS Image
 *
 */
public class VerdiGradientBarPainter implements BarPainter, Serializable {

    /**
	 * 
	 */
	private static final long serialVersionUID = 2223611610042596298L;
     ...
     */
    public VerdiGradientBarPainter() {
        this(0.10, 0.20, 0.80);
    }
     ...
     */
    public VerdiGradientBarPainter(double g1, double g2, double g3) {
        this.g1 = g1;
        this.g2 = g2;
        this.g3 = g3;
    }
    ...
    public void paintBar(Graphics2D g2, BarRenderer renderer, int row,
        ...
        if (base == RectangleEdge.TOP || base == RectangleEdge.BOTTOM) {
        	Rectangle2D.Double tmpBar = new Rectangle2D.Double(0, 0,  bar.getWidth(), bar.getHeight());    			
        	BufferedImage img = new BufferedImage((int)bar.getWidth(), (int) bar.getHeight(), BufferedImage.TYPE_INT_RGB);
        	Graphics2D g = img.createGraphics();
        	
            Rectangle2D[] regions = splitVerticalBar(tmpBar, this.g1, this.g2,
                    this.g3);
        	...
        	g2.drawImage(img, (int)bar.getMinX(), (int)bar.getMinY(), null);
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof VerdiGradientBarPainter)) {
            return false;
        }
        VerdiGradientBarPainter that = (VerdiGradientBarPainter) obj;
        if (this.g1 != that.g1) {
            return false;
        }
        if (this.g2 != that.g2) {
