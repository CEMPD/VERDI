...
public class Formatter {
     ...
     */
    public Citation authority = Citations.OGC;
    ...
    public void setAuthority(Citation anAuthority) {
        this.authority = anAuthority;
        this.unitFormat = GeoToolsUnitFormat.getInstance(anAuthority);
    }
    ...
    public void append(final Formattable formattable) {
        ...
        if (identifier!=null && authorityAllowed(info)) {
            final Citation citAuthority = identifier.getAuthority();
            if (citAuthority != null) {
                /*
                 ...
                 */
                InternationalString inter = citAuthority.getTitle();
                String title = (inter!=null) ? inter.toString(symbols.locale) : null;
                for (final InternationalString alt : citAuthority.getAlternateTitles()) {
                    if (alt != null) {
