...
Figure 107. Tile Plot of Fine Scale Gridded Dataset<br>

  
  ![VERDI GIS Layers UI](./media/image110.png){#fig:Figure107} <br>
...
Figure 108. Add Fine Scale GIS layer<br>

  ![The pop-up window to load other GIS Layers UI](./media/image111.png){fig:Figure108} <br> 
...
Figure 109. Tile Plot with NYC Street Centerlines<br>
	
  ![The tile plot with NYC street centerlines](./media/image112.png){fig:Figure109} <br>
